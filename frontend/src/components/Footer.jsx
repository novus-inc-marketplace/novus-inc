...
function Footer() {
  return (
    <footer className="container-fluid bg-primary text-light footer wow fadeIn" data-wow-delay="0.1s">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
          <div className="col-md-6 col-lg-3">
            ...
            <div className="flex pt-2">
              <a className="btn btn-outline-light btn-social" href="https://twitter.com/novusinc" target="_blank" rel="noopener noreferrer"><i className="fab fa-twitter"></i></a>
              <a className="btn btn-outline-light btn-social" href="https://facebook.com/novusinc" target="_blank" rel="noopener noreferrer"><i className="fab fa-facebook-f"></i></a>
              <a className="btn btn-outline-light btn-social" href="https://instagram.com/novusinc" target="_blank" rel="noopener noreferrer"><i className="fab fa-instagram"></i></a>
              <a className="btn btn-outline-light btn-social" href="https://linkedin.com/company/novusinc" target="_blank" rel="noopener noreferrer"><i className="fab fa-linkedin-in"></i></a>
            </div>
          </div>
          <div className="col-md-6 col-lg-3">
            ...
            <a className="btn btn-link" href="#">Privacy Policy</a> {/* Placeholder */}
            <a className="btn btn-link" href="#">Terms & Condition</a> {/* Placeholder */}
        ...
        <div className="copyright">
          <div className="grid md:grid-cols-2">
            <div className="text-center md:text-left mb-3 md:mb-0">
              &copy; {new Date().getFullYear()} <Link className="border-bottom" to="/">Novus Inc</Link>, All Right Reserved.
              Designed By <a className="border-bottom" href="https://novus-inc-marketplace.github.io/portfolio_website" target="_blank" rel="noopener noreferrer">HTML Codex</a>
            </div>
      ...
      <a href="https://wa.me/254798808105" className="whatsapp-button" target="_blank" rel="noopener noreferrer">

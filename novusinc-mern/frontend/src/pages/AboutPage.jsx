        ...
        <div className="container py-5 px-lg-5">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="text-center animate-fadeInUp">
              ...
              <h1 className="text-white mb-2">4</h1> {/* CounterUp will be a separate component */}
            ...
            <div className="text-center animate-fadeInUp">
              ...
              <h1 className="text-white mb-2">26</h1> {/* CounterUp will be a separate component */}
              <p className="text-white mb-0">Satisfied Clients</p>
            </div>
            <div className="text-center animate-fadeInUp">
              <i className="fa fa-check fa-3x text-secondary mb-3"></i>
              <h1 className="text-white mb-2">29</h1> {/* CounterUp will be a separate component */}
